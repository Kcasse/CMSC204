...
public class MyStackTest {
    ...
    public void testPopStudent() {
      try{
          ...
          //Stack is empty, next statement should cause a StackUnderFlowException
          doubleS.pop();
          assertTrue("This should have caused an StackUnderflowException", false);
      }catch (StackUnderflowException e){
          assertTrue("This should have caused an StackUnderflowException",true);
    ...
    public void testPushStudent() {
        try {
            assertEquals(3, doubleS.size());//the size is 3 right now
            assertEquals(true, doubleS.push(4.0));//add a 4th
            assertEquals(4, doubleS.size());//4
            assertEquals(true, doubleS.push(5.0));//+1
            assertEquals(5, doubleS.size());//5
            //Queue is full, next statement should cause StackOverFlowException
            doubleS.push(6.0);//the original size is 5 so this will cause a StackOverFlowException
            //but it will be  caught in the catch statement not the try
            assertTrue("This should have caused an StackOverflowException", false);
        }
        catch (StackOverflowException e){
            assertTrue("This should have caused an StackOverflowException", true);
